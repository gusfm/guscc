...
static int lex_test_1(void)
{
    ...
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "42") == 0);
    ASSERT(check_next_token(&lex, ';') == 0);
    ASSERT(check_next_token(&lex, '}') == 0);
...
static int lex_test_2(void)
{
    ...
    ASSERT(check_next_token(&lex, '(') == 0);
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "1") == 0);
    ASSERT(check_next_token(&lex, '<') == 0);
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "2") == 0);
    ASSERT(check_next_token(&lex, ')') == 0);
    ASSERT(check_next_token(&lex, TOKEN_KW_RETURN) == 0);
    ...
    ASSERT(check_next_token(&lex, TOKEN_KW_IF) == 0);
    ASSERT(check_next_token(&lex, '(') == 0);
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "3") == 0);
    ASSERT(check_next_token(&lex, TOKEN_LE_OP) == 0);
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "4") == 0);
    ASSERT(check_next_token(&lex, ')') == 0);
    ASSERT(check_next_token(&lex, TOKEN_KW_RETURN) == 0);
    ASSERT(check_next_token_str(&lex, TOKEN_CONSTANT, "1") == 0);
    ASSERT(check_next_token(&lex, ';') == 0);
